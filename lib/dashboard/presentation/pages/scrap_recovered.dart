...
class ScrapRecoveredScreen extends StatefulWidget {
  const ScrapRecoveredScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<ScrapRecoveredScreen> createState() => _ScrapRecoveredScreenState();
}

class _ScrapRecoveredScreenState extends State<ScrapRecoveredScreen> {
  final TextEditingController assetIdController = TextEditingController();
  final GlobalKey<FormState> _webScrapRecoveredFormKey = GlobalKey<FormState>();
  final GlobalKey<FormState> _tabScrapRecoveredFormKey = GlobalKey<FormState>();
  final GlobalKey<FormState> _mobileScrapRecoveredFormKey =
      GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
        ...
        child: ResponsiveBuilder(
          builder: (context, sizingInformation) {
            if (sizingInformation.isMobile) {
              return ScrapRecoveredMobile(
                deleteFormKey: _mobileScrapRecoveredFormKey,
                assetIdController: assetIdController,
                authProvider: authProvider,
              );
            } else if (sizingInformation.isTablet) {
              return ScrapRecoveredTab(
                size: size,
                deleteFormKey: _tabScrapRecoveredFormKey,
                assetIdController: assetIdController,
                authProvider: authProvider,
              );
            } else {
              return ScrapRecoveredWeb(
                size: size,
                deleteFormKey: _webScrapRecoveredFormKey,
                assetIdController: assetIdController,
                authProvider: authProvider,
              );
            }
...
class ScrapRecoveredWeb extends StatefulWidget {
  const ScrapRecoveredWeb({
    super.key,
    required Size size,
  ...
  @override
  State<ScrapRecoveredWeb> createState() => _ScrapRecoveredWebState();
}

class _ScrapRecoveredWebState extends State<ScrapRecoveredWeb> {
  Future<void> scrapRecovered(BuildContext context, String assetId) async {
    try {
      var url = 'http://192.168.4.137:3000/asset/recoverAsset/$assetId';
      Dio dio = Dio();
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const CustomHeading(
                title: ' recover the Scrap Assets', showBackButton: true),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ContinueButton(
                                    ...
                                    text: "Recover scrap",
                                    ontap: () async {
                                      scrapRecovered(context,
                                          widget.assetIdController.text);
                                    },
                                  ),
                                  const SizedBox(
                                    height: 20,
...
class ScrapRecoveredTab extends StatefulWidget {
  const ScrapRecoveredTab({
    super.key,
    required Size size,
    required GlobalKey<FormState> deleteFormKey,
    required this.assetIdController,
  ...
  @override
  State<ScrapRecoveredTab> createState() => _ScrapRecoveredTabState();
}

class _ScrapRecoveredTabState extends State<ScrapRecoveredTab> {
                  ...
                  child: Column(
                    children: [
                      ...
                      ContinueButton(
                        ...
                        ontap: () async {
                          scrapRecovered(
                              context, widget.assetIdController.text);
                        },
                      ),
                      const SizedBox(
                        height: 20,
...
class ScrapRecoveredMobile extends StatefulWidget {
  const ScrapRecoveredMobile({
    super.key,
    required GlobalKey<FormState> deleteFormKey,
    required this.assetIdController,
    required AuthProvider authProvider,
  ...
  @override
  State<ScrapRecoveredMobile> createState() => _ScrapRecoveredMobileState();
}

class _ScrapRecoveredMobileState extends State<ScrapRecoveredMobile> {
  Future<void> scrapRecovered(BuildContext context, String assetId) async {
    try {
      var url = 'http://192.168.4.137:3000/asset/recoverAsset/$assetId';
      Dio dio = Dio();
                ...
                child: Column(
                  children: [
                    CustomTextFormField(
                      ...
                      width: 400,
                      textInputType: TextInputType.number,
                      hintText: "Please Enter Asset Id  to recover scrap ",
                      onChanged: (value) {},
                      prefixIcon: Icon(
                        Icons.laptop_chromebook,
                        color: AppTheme.primaryColor,
